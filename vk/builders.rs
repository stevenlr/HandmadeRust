...
impl<'a> VkAllocationCallbacksBuilder<'a>
{
    ...
    pub fn p_user_data(
        mut self,
        value: Option<&'a mut core::ffi::c_void>,
...
impl<'a> VkWin32SurfaceCreateInfoKHRBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsWin32SurfaceCreateInfoKHR>(
        mut self,
        next: &'a mut T,
    ) -> VkWin32SurfaceCreateInfoKHRBuilder<'a>
    {
        unsafe {
...
impl<'a> VkSurfaceCapabilitiesKHRBuilder<'a>
{
    ...
    pub fn supported_transforms(
        mut self,
        value: VkSurfaceTransformFlagsKHR,
    ) -> VkSurfaceCapabilitiesKHRBuilder<'a>
    {
    ...
    pub fn supported_composite_alpha(
        mut self,
        value: VkCompositeAlphaFlagsKHR,
    ) -> VkSurfaceCapabilitiesKHRBuilder<'a>
    {
...
impl<'a> VkSwapchainCreateInfoKHRBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsSwapchainCreateInfoKHR>(
        mut self,
        next: &'a mut T,
    ) -> VkSwapchainCreateInfoKHRBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
    ...
    pub fn flags(mut self, value: VkSwapchainCreateFlagsKHR)
        -> VkSwapchainCreateInfoKHRBuilder<'a>
    {
        self.s.flags = value;
        self
    ...
    pub fn image_sharing_mode(mut self, value: VkSharingMode)
        -> VkSwapchainCreateInfoKHRBuilder<'a>
    {
...
impl<'a> VkDebugUtilsMessengerCallbackDataEXTBuilder<'a>
{
    ...
    ) -> VkDebugUtilsMessengerCallbackDataEXTBuilder<'a>
    {
        self.s.s_type = value;
        self
    }
    ...
    pub fn flags(
        mut self,
        value: VkDebugUtilsMessengerCallbackDataFlagsEXT,
    ) -> VkDebugUtilsMessengerCallbackDataEXTBuilder<'a>
    {
        self.s.flags = value;
        self
    ...
    pub fn p_message(mut self, values: &'a [u8])
        -> VkDebugUtilsMessengerCallbackDataEXTBuilder<'a>
    {
    ...
    pub fn p_objects(
        mut self,
        values: &'a [VkDebugUtilsObjectNameInfoEXT],
    ) -> VkDebugUtilsMessengerCallbackDataEXTBuilder<'a>
    {
...
impl<'a> VkDebugUtilsObjectNameInfoEXTBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsDebugUtilsObjectNameInfoEXT>(
        mut self,
        next: &'a mut T,
    ) -> VkDebugUtilsObjectNameInfoEXTBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
...
impl<'a> VkDebugUtilsMessengerCreateInfoEXTBuilder<'a>
{
    ...
    pub fn s_type(mut self, value: VkStructureType)
    ...
    pub fn flags(
        mut self,
        value: VkDebugUtilsMessengerCreateFlagsEXT,
    ) -> VkDebugUtilsMessengerCreateInfoEXTBuilder<'a>
    {
        self.s.flags = value;
        self
    ...
    pub fn message_severity(
        mut self,
        value: VkDebugUtilsMessageSeverityFlagsEXT,
    ) -> VkDebugUtilsMessengerCreateInfoEXTBuilder<'a>
    {
    ...
    pub fn message_type(
        mut self,
        value: VkDebugUtilsMessageTypeFlagsEXT,
    ) -> VkDebugUtilsMessengerCreateInfoEXTBuilder<'a>
    {
...
impl<'a> VkDebugUtilsObjectTagInfoEXTBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsDebugUtilsObjectTagInfoEXT>(
        mut self,
        next: &'a mut T,
    ) -> VkDebugUtilsObjectTagInfoEXTBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
...
impl<'a> VkBaseInStructureBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsBaseInStructure>(
        mut self,
        next: &'a mut T,
    ) -> VkBaseInStructureBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
...
impl<'a> VkBaseOutStructureBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsBaseOutStructure>(
        mut self,
        next: &'a mut T,
    ) -> VkBaseOutStructureBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
...
impl<'a> VkBufferMemoryBarrierBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsBufferMemoryBarrier>(
        mut self,
        next: &'a mut T,
    ) -> VkBufferMemoryBarrierBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
...
impl<'a> VkRenderPassBeginInfoBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsRenderPassBeginInfo>(
        mut self,
        next: &'a mut T,
    ) -> VkRenderPassBeginInfoBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
    ...
    pub fn p_clear_values(mut self, values: &'a [VkClearValue])
        -> VkRenderPassBeginInfoBuilder<'a>
    {
...
impl<'a> VkCommandBufferBeginInfoBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsCommandBufferBeginInfo>(
        mut self,
        next: &'a mut T,
    ) -> VkCommandBufferBeginInfoBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
    ...
    pub fn flags(mut self, value: VkCommandBufferUsageFlags)
        -> VkCommandBufferBeginInfoBuilder<'a>
    {
        self.s.flags = value;
        self
    ...
    pub fn p_inheritance_info(
        mut self,
        value: Option<&'a VkCommandBufferInheritanceInfo>,
    ) -> VkCommandBufferBeginInfoBuilder<'a>
    {
...
impl<'a> VkCommandBufferInheritanceInfoBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsCommandBufferInheritanceInfo>(
        mut self,
        next: &'a mut T,
    ) -> VkCommandBufferInheritanceInfoBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
    ...
    pub fn framebuffer(mut self, value: VkFramebuffer)
        -> VkCommandBufferInheritanceInfoBuilder<'a>
    {
        self.s.framebuffer = value;
        self
    ...
    pub fn pipeline_statistics(
        mut self,
        value: VkQueryPipelineStatisticFlags,
    ) -> VkCommandBufferInheritanceInfoBuilder<'a>
    {
...
impl<'a> VkCommandBufferAllocateInfoBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsCommandBufferAllocateInfo>(
        mut self,
        next: &'a mut T,
    ) -> VkCommandBufferAllocateInfoBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
...
impl<'a> VkCommandPoolCreateInfoBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsCommandPoolCreateInfo>(
        mut self,
        next: &'a mut T,
    ) -> VkCommandPoolCreateInfoBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
...
impl<'a> VkRenderPassCreateInfoBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsRenderPassCreateInfo>(
        mut self,
        next: &'a mut T,
    ) -> VkRenderPassCreateInfoBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
    ...
    pub fn p_attachments(
        mut self,
        values: &'a [VkAttachmentDescription],
    ) -> VkRenderPassCreateInfoBuilder<'a>
    {
...
impl<'a> VkSubpassDescriptionBuilder<'a>
{
    ...
    pub fn p_input_attachments(
        mut self,
        values: &'a [VkAttachmentReference],
    ) -> VkSubpassDescriptionBuilder<'a>
    {
    ...
    pub fn p_depth_stencil_attachment(
        mut self,
        value: Option<&'a VkAttachmentReference>,
    ) -> VkSubpassDescriptionBuilder<'a>
    {
...
impl<'a> VkAttachmentDescriptionBuilder<'a>
{
    ...
    pub fn flags(
        mut self,
        value: VkAttachmentDescriptionFlags,
    ) -> VkAttachmentDescriptionBuilder<'a>
    {
        self.s.flags = value;
        self
    }
...
impl<'a> VkFramebufferCreateInfoBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsFramebufferCreateInfo>(
        mut self,
        next: &'a mut T,
    ) -> VkFramebufferCreateInfoBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
    ...
    pub fn p_attachments(mut self, values: &'a [VkImageView])
        -> VkFramebufferCreateInfoBuilder<'a>
    {
        self.s.attachment_count = values.len() as _;
        self.s.p_attachments = values.as_ptr();
...
impl<'a> VkWriteDescriptorSetBuilder<'a>
{
    ...
    pub fn p_image_info(
        mut self,
        values: &'a [VkDescriptorImageInfo],
    ) -> VkWriteDescriptorSetBuilder<'a>
    {
    ...
    pub fn p_buffer_info(
        mut self,
        values: &'a [VkDescriptorBufferInfo],
    ) -> VkWriteDescriptorSetBuilder<'a>
    {
        self.s.descriptor_count = values.len() as _;
...
impl<'a> VkDescriptorSetAllocateInfoBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsDescriptorSetAllocateInfo>(
        mut self,
        next: &'a mut T,
    ) -> VkDescriptorSetAllocateInfoBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
    ...
    pub fn p_set_layouts(
        mut self,
        values: &'a [VkDescriptorSetLayout],
    ) -> VkDescriptorSetAllocateInfoBuilder<'a>
    {
...
impl<'a> VkDescriptorPoolCreateInfoBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsDescriptorPoolCreateInfo>(
        mut self,
        next: &'a mut T,
    ) -> VkDescriptorPoolCreateInfoBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
    ...
    pub fn flags(
        mut self,
        value: VkDescriptorPoolCreateFlags,
    ) -> VkDescriptorPoolCreateInfoBuilder<'a>
    {
        self.s.flags = value;
        self
...
impl<'a> VkDescriptorSetLayoutCreateInfoBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsDescriptorSetLayoutCreateInfo>(
        mut self,
        next: &'a mut T,
    ) -> VkDescriptorSetLayoutCreateInfoBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
    ...
    pub fn flags(
        mut self,
        value: VkDescriptorSetLayoutCreateFlags,
    ) -> VkDescriptorSetLayoutCreateInfoBuilder<'a>
    {
        self.s.flags = value;
        self
    ...
    pub fn p_bindings(
        mut self,
        values: &'a [VkDescriptorSetLayoutBinding],
    ) -> VkDescriptorSetLayoutCreateInfoBuilder<'a>
    {
...
impl<'a> VkDescriptorSetLayoutBindingBuilder<'a>
{
    ...
    ) -> VkDescriptorSetLayoutBindingBuilder<'a>
    {
        self.s.descriptor_type = value;
        self
    }
...
impl<'a> VkPipelineLayoutCreateInfoBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsPipelineLayoutCreateInfo>(
        mut self,
        next: &'a mut T,
    ) -> VkPipelineLayoutCreateInfoBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
    ...
    pub fn flags(
        mut self,
        value: VkPipelineLayoutCreateFlags,
    ) -> VkPipelineLayoutCreateInfoBuilder<'a>
    {
        self.s.flags = value;
        self
    ...
    pub fn push_constant_range_count(mut self, value: u32)
        -> VkPipelineLayoutCreateInfoBuilder<'a>
    {
...
impl<'a> VkComputePipelineCreateInfoBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsComputePipelineCreateInfo>(
        mut self,
        next: &'a mut T,
    ) -> VkComputePipelineCreateInfoBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
...
impl<'a> VkPipelineShaderStageCreateInfoBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsPipelineShaderStageCreateInfo>(
        mut self,
        next: &'a mut T,
    ) -> VkPipelineShaderStageCreateInfoBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
    ...
    pub fn flags(
        mut self,
        value: VkPipelineShaderStageCreateFlags,
    ) -> VkPipelineShaderStageCreateInfoBuilder<'a>
    {
        self.s.flags = value;
        self
    ...
    pub fn p_specialization_info(
        mut self,
        value: Option<&'a VkSpecializationInfo>,
    ) -> VkPipelineShaderStageCreateInfoBuilder<'a>
    {
...
impl<'a> VkSpecializationInfoBuilder<'a>
{
    ...
    pub fn p_map_entries(
        mut self,
        values: &'a [VkSpecializationMapEntry],
    ) -> VkSpecializationInfoBuilder<'a>
    {
...
impl<'a> VkGraphicsPipelineCreateInfoBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsGraphicsPipelineCreateInfo>(
        mut self,
        next: &'a mut T,
    ) -> VkGraphicsPipelineCreateInfoBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
    ...
    pub fn flags(mut self, value: VkPipelineCreateFlags)
        -> VkGraphicsPipelineCreateInfoBuilder<'a>
    {
        self.s.flags = value;
        self
    ...
    pub fn p_stages(
        mut self,
        values: &'a [VkPipelineShaderStageCreateInfo],
    ) -> VkGraphicsPipelineCreateInfoBuilder<'a>
    {
    ...
    pub fn p_vertex_input_state(
        mut self,
        value: Option<&'a VkPipelineVertexInputStateCreateInfo>,
    ) -> VkGraphicsPipelineCreateInfoBuilder<'a>
    {
    ...
    pub fn p_input_assembly_state(
        mut self,
        value: Option<&'a VkPipelineInputAssemblyStateCreateInfo>,
    ) -> VkGraphicsPipelineCreateInfoBuilder<'a>
    {
    ...
    pub fn p_tessellation_state(
        mut self,
        value: Option<&'a VkPipelineTessellationStateCreateInfo>,
    ) -> VkGraphicsPipelineCreateInfoBuilder<'a>
    {
    ...
    pub fn p_viewport_state(
        mut self,
        value: Option<&'a VkPipelineViewportStateCreateInfo>,
    ) -> VkGraphicsPipelineCreateInfoBuilder<'a>
    {
    ...
    pub fn p_rasterization_state(
        mut self,
        value: &'a VkPipelineRasterizationStateCreateInfo,
    ) -> VkGraphicsPipelineCreateInfoBuilder<'a>
    {
    ...
    pub fn p_multisample_state(
        mut self,
        value: Option<&'a VkPipelineMultisampleStateCreateInfo>,
    ) -> VkGraphicsPipelineCreateInfoBuilder<'a>
    {
    ...
    pub fn p_depth_stencil_state(
        mut self,
        value: Option<&'a VkPipelineDepthStencilStateCreateInfo>,
    ) -> VkGraphicsPipelineCreateInfoBuilder<'a>
    {
    ...
    pub fn p_color_blend_state(
        mut self,
        value: Option<&'a VkPipelineColorBlendStateCreateInfo>,
    ) -> VkGraphicsPipelineCreateInfoBuilder<'a>
    {
    ...
    pub fn p_dynamic_state(
        mut self,
        value: Option<&'a VkPipelineDynamicStateCreateInfo>,
    ) -> VkGraphicsPipelineCreateInfoBuilder<'a>
    {
...
impl<'a> VkPipelineDynamicStateCreateInfoBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsPipelineDynamicStateCreateInfo>(
        mut self,
        next: &'a mut T,
    ) -> VkPipelineDynamicStateCreateInfoBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
    ...
    pub fn flags(
        mut self,
        value: VkPipelineDynamicStateCreateFlags,
    ) -> VkPipelineDynamicStateCreateInfoBuilder<'a>
    {
        self.s.flags = value;
        self
    ...
    pub fn dynamic_state_count(mut self, value: u32)
        -> VkPipelineDynamicStateCreateInfoBuilder<'a>
    {
...
impl<'a> VkPipelineColorBlendStateCreateInfoBuilder<'a>
{
    ...
    pub fn s_type(
        mut self,
        value: VkStructureType,
    ) -> VkPipelineColorBlendStateCreateInfoBuilder<'a>
    {
        self.s.s_type = value;
        self
    }
    ...
    pub fn flags(
        mut self,
        value: VkPipelineColorBlendStateCreateFlags,
    ) -> VkPipelineColorBlendStateCreateInfoBuilder<'a>
    {
        self.s.flags = value;
        self
    ...
    pub fn attachment_count(mut self, value: u32)
        -> VkPipelineColorBlendStateCreateInfoBuilder<'a>
    {
        self.s.attachment_count = value;
        self
    ...
    pub fn p_attachments(
        mut self,
        values: &'a [VkPipelineColorBlendAttachmentState],
    ) -> VkPipelineColorBlendStateCreateInfoBuilder<'a>
    {
        self.s.attachment_count = values.len() as _;
        self.s.p_attachments = values.as_ptr();
...
impl<'a> VkPipelineColorBlendAttachmentStateBuilder<'a>
{
    ...
    pub fn src_color_blend_factor(
        mut self,
        value: VkBlendFactor,
    ) -> VkPipelineColorBlendAttachmentStateBuilder<'a>
    {
...
impl<'a> VkPipelineDepthStencilStateCreateInfoBuilder<'a>
{
    ...
    pub fn s_type(
        mut self,
        value: VkStructureType,
    ) -> VkPipelineDepthStencilStateCreateInfoBuilder<'a>
    {
        self.s.s_type = value;
        self
    }
    ...
    pub fn flags(
        mut self,
        value: VkPipelineDepthStencilStateCreateFlags,
    ) -> VkPipelineDepthStencilStateCreateInfoBuilder<'a>
    {
        self.s.flags = value;
        self
...
impl<'a> VkPipelineMultisampleStateCreateInfoBuilder<'a>
{
    ...
    pub fn s_type(
        mut self,
        value: VkStructureType,
    ) -> VkPipelineMultisampleStateCreateInfoBuilder<'a>
    {
        self.s.s_type = value;
        self
    }
    ...
    pub fn flags(
        mut self,
        value: VkPipelineMultisampleStateCreateFlags,
    ) -> VkPipelineMultisampleStateCreateInfoBuilder<'a>
    {
        self.s.flags = value;
        self
...
impl<'a> VkPipelineRasterizationStateCreateInfoBuilder<'a>
{
    ...
    pub fn s_type(
        mut self,
        value: VkStructureType,
    ) -> VkPipelineRasterizationStateCreateInfoBuilder<'a>
    {
        self.s.s_type = value;
        self
    }
    ...
    pub fn flags(
        mut self,
        value: VkPipelineRasterizationStateCreateFlags,
    ) -> VkPipelineRasterizationStateCreateInfoBuilder<'a>
    {
        self.s.flags = value;
        self
...
impl<'a> VkPipelineViewportStateCreateInfoBuilder<'a>
{
    ...
    pub fn s_type(mut self, value: VkStructureType)
        -> VkPipelineViewportStateCreateInfoBuilder<'a>
    {
        self.s.s_type = value;
        self
    }
    ...
    pub fn flags(
        mut self,
        value: VkPipelineViewportStateCreateFlags,
    ) -> VkPipelineViewportStateCreateInfoBuilder<'a>
    {
        self.s.flags = value;
        self
...
impl<'a> VkPipelineTessellationStateCreateInfoBuilder<'a>
{
    ...
    pub fn s_type(
        mut self,
        value: VkStructureType,
    ) -> VkPipelineTessellationStateCreateInfoBuilder<'a>
    {
        self.s.s_type = value;
        self
    }
    ...
    pub fn flags(
        mut self,
        value: VkPipelineTessellationStateCreateFlags,
    ) -> VkPipelineTessellationStateCreateInfoBuilder<'a>
    {
        self.s.flags = value;
        self
...
impl<'a> VkPipelineInputAssemblyStateCreateInfoBuilder<'a>
{
    ...
    pub fn s_type(
        mut self,
        value: VkStructureType,
    ) -> VkPipelineInputAssemblyStateCreateInfoBuilder<'a>
    {
        self.s.s_type = value;
        self
    }
    ...
    pub fn flags(
        mut self,
        value: VkPipelineInputAssemblyStateCreateFlags,
    ) -> VkPipelineInputAssemblyStateCreateInfoBuilder<'a>
    {
        self.s.flags = value;
        self
...
impl<'a> VkPipelineVertexInputStateCreateInfoBuilder<'a>
{
    ...
    pub fn s_type(
        mut self,
        value: VkStructureType,
    ) -> VkPipelineVertexInputStateCreateInfoBuilder<'a>
    {
        self.s.s_type = value;
        self
    }
    ...
    pub fn flags(
        mut self,
        value: VkPipelineVertexInputStateCreateFlags,
    ) -> VkPipelineVertexInputStateCreateInfoBuilder<'a>
    {
        self.s.flags = value;
        self
    ...
    pub fn p_vertex_binding_descriptions(
        mut self,
        values: &'a [VkVertexInputBindingDescription],
    ) -> VkPipelineVertexInputStateCreateInfoBuilder<'a>
    {
    ...
    pub fn p_vertex_attribute_descriptions(
        mut self,
        values: &'a [VkVertexInputAttributeDescription],
    ) -> VkPipelineVertexInputStateCreateInfoBuilder<'a>
    {
...
impl<'a> VkVertexInputBindingDescriptionBuilder<'a>
{
    ...
    ) -> VkVertexInputBindingDescriptionBuilder<'a>
    {
...
impl<'a> VkPipelineCacheCreateInfoBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsPipelineCacheCreateInfo>(
        mut self,
        next: &'a mut T,
    ) -> VkPipelineCacheCreateInfoBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
    ...
    pub fn flags(
        mut self,
        value: VkPipelineCacheCreateFlags,
    ) -> VkPipelineCacheCreateInfoBuilder<'a>
    {
        self.s.flags = value;
        self
...
impl<'a> VkShaderModuleCreateInfoBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsShaderModuleCreateInfo>(
        mut self,
        next: &'a mut T,
    ) -> VkShaderModuleCreateInfoBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
    ...
    pub fn flags(mut self, value: VkShaderModuleCreateFlags)
        -> VkShaderModuleCreateInfoBuilder<'a>
    {
        self.s.flags = value;
        self
...
impl<'a> VkImageViewCreateInfoBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsImageViewCreateInfo>(
        mut self,
        next: &'a mut T,
    ) -> VkImageViewCreateInfoBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
...
impl<'a> VkBufferViewCreateInfoBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsBufferViewCreateInfo>(
        mut self,
        next: &'a mut T,
    ) -> VkBufferViewCreateInfoBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
...
impl<'a> VkQueryPoolCreateInfoBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsQueryPoolCreateInfo>(
        mut self,
        next: &'a mut T,
    ) -> VkQueryPoolCreateInfoBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
...
impl<'a> VkSemaphoreCreateInfoBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsSemaphoreCreateInfo>(
        mut self,
        next: &'a mut T,
    ) -> VkSemaphoreCreateInfoBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
...
impl<'a> VkBindSparseInfoBuilder<'a>
{
    ...
    pub fn p_buffer_binds(
        mut self,
        values: &'a [VkSparseBufferMemoryBindInfo],
    ) -> VkBindSparseInfoBuilder<'a>
    {
    ...
    pub fn p_image_opaque_binds(
        mut self,
        values: &'a [VkSparseImageOpaqueMemoryBindInfo],
    ) -> VkBindSparseInfoBuilder<'a>
    {
    ...
    pub fn p_image_binds(
        mut self,
        values: &'a [VkSparseImageMemoryBindInfo],
    ) -> VkBindSparseInfoBuilder<'a>
    {
...
impl<'a> VkSparseImageMemoryBindInfoBuilder<'a>
{
    ...
    pub fn p_binds(
        mut self,
        values: &'a [VkSparseImageMemoryBind],
    ) -> VkSparseImageMemoryBindInfoBuilder<'a>
    {
...
impl<'a> VkSparseImageOpaqueMemoryBindInfoBuilder<'a>
{
    ...
    pub fn p_binds(
        mut self,
        values: &'a [VkSparseMemoryBind],
    ) -> VkSparseImageOpaqueMemoryBindInfoBuilder<'a>
    {
        self.s.bind_count = values.len() as _;
        self.s.p_binds = values.as_ptr();
        self
...
impl<'a> VkSparseBufferMemoryBindInfoBuilder<'a>
{
    ...
    pub fn p_binds(
        mut self,
        values: &'a [VkSparseMemoryBind],
    ) -> VkSparseBufferMemoryBindInfoBuilder<'a>
    {
        self.s.bind_count = values.len() as _;
        self.s.p_binds = values.as_ptr();
        self
...
impl<'a> VkSparseImageFormatPropertiesBuilder<'a>
{
    ...
    ) -> VkSparseImageFormatPropertiesBuilder<'a>
    {
        self.s.aspect_mask = value;
        self
    }
    ...
    pub fn flags(
        mut self,
        value: VkSparseImageFormatFlags,
    ) -> VkSparseImageFormatPropertiesBuilder<'a>
    {
        self.s.flags = value;
        self
...
impl<'a> VkSparseImageMemoryRequirementsBuilder<'a>
{
    ...
    ) -> VkSparseImageMemoryRequirementsBuilder<'a>
    {
...
impl<'a> VkSubmitInfoBuilder<'a>
{
    ...
    pub fn p_wait_dst_stage_mask(
        mut self,
        values: &'a [VkPipelineStageFlags],
    ) -> VkSubmitInfoBuilder<'a>
    {
        self.s.wait_semaphore_count = values.len() as _;
...
impl<'a> VkDeviceCreateInfoBuilder<'a>
{
    ...
    pub fn p_queue_create_infos(
        mut self,
        values: &'a [VkDeviceQueueCreateInfo],
    ) -> VkDeviceCreateInfoBuilder<'a>
    {
    ...
    pub fn p_enabled_features(
        mut self,
        value: Option<&'a VkPhysicalDeviceFeatures>,
    ) -> VkDeviceCreateInfoBuilder<'a>
    {
...
impl<'a> VkPhysicalDeviceFeaturesBuilder<'a>
{
    ...
    pub fn draw_indirect_first_instance(
        mut self,
        value: bool,
    ) -> VkPhysicalDeviceFeaturesBuilder<'a>
    {
    ...
    pub fn fragment_stores_and_atomics(mut self, value: bool)
        -> VkPhysicalDeviceFeaturesBuilder<'a>
    {
    ...
    {
        self.s.shader_uniform_buffer_array_dynamic_indexing =
    ...
    {
        self.s.shader_storage_buffer_array_dynamic_indexing =
            if value { VK_TRUE } else { VK_FALSE };
        self
    }
    ...
    pub fn sparse_residency_image_2_d(mut self, value: bool)
        -> VkPhysicalDeviceFeaturesBuilder<'a>
    {
    ...
    pub fn sparse_residency_image_3_d(mut self, value: bool)
        -> VkPhysicalDeviceFeaturesBuilder<'a>
    {
    ...
    pub fn sparse_residency_2_samples(mut self, value: bool)
        -> VkPhysicalDeviceFeaturesBuilder<'a>
    {
    ...
    pub fn sparse_residency_4_samples(mut self, value: bool)
        -> VkPhysicalDeviceFeaturesBuilder<'a>
    {
    ...
    pub fn sparse_residency_8_samples(mut self, value: bool)
        -> VkPhysicalDeviceFeaturesBuilder<'a>
    {
    ...
    pub fn sparse_residency_16_samples(mut self, value: bool)
        -> VkPhysicalDeviceFeaturesBuilder<'a>
    {
...
impl<'a> VkDeviceQueueCreateInfoBuilder<'a>
{
    ...
    pub fn push_next<T: ExtendsDeviceQueueCreateInfo>(
        mut self,
        next: &'a mut T,
    ) -> VkDeviceQueueCreateInfoBuilder<'a>
    {
        unsafe {
            let last = get_last_base_out_struct_chain(next as *mut T as *mut VkBaseOutStructure);
            (*last).p_next = self.s.p_next as _;
...
impl<'a> VkPhysicalDeviceMemoryPropertiesBuilder<'a>
{
    ...
    pub fn memory_types(
        mut self,
        value: [VkMemoryType; 32],
    ) -> VkPhysicalDeviceMemoryPropertiesBuilder<'a>
    {
...
impl<'a> VkQueueFamilyPropertiesBuilder<'a>
{
    ...
    pub fn min_image_transfer_granularity(
        mut self,
        value: VkExtent3D,
    ) -> VkQueueFamilyPropertiesBuilder<'a>
    {
...
impl<'a> VkPhysicalDevicePropertiesBuilder<'a>
{
    ...
    ) -> VkPhysicalDevicePropertiesBuilder<'a>
    {
    ...
    pub fn limits(mut self, value: VkPhysicalDeviceLimits)
        -> VkPhysicalDevicePropertiesBuilder<'a>
    {
        self.s.limits = value;
        self
...
impl<'a> VkPhysicalDeviceSparsePropertiesBuilder<'a>
{
    ...
    pub fn residency_standard_2_d_block_shape(
        mut self,
        value: bool,
    ) -> VkPhysicalDeviceSparsePropertiesBuilder<'a>
    {
        self.s.residency_standard_2_d_block_shape = if value { VK_TRUE } else { VK_FALSE };
        self
    }

    pub fn residency_standard_2_d_multisample_block_shape(
        mut self,
        value: bool,
    ) -> VkPhysicalDeviceSparsePropertiesBuilder<'a>
    {
        self.s.residency_standard_2_d_multisample_block_shape =
            if value { VK_TRUE } else { VK_FALSE };
        self
    }

    pub fn residency_standard_3_d_block_shape(
        mut self,
        value: bool,
    ) -> VkPhysicalDeviceSparsePropertiesBuilder<'a>
    {
...
impl<'a> VkPhysicalDeviceLimitsBuilder<'a>
{
    ...
    pub fn buffer_image_granularity(
        mut self,
        value: VkDeviceSize,
    ) -> VkPhysicalDeviceLimitsBuilder<'a>
    {
    ...
    pub fn max_geometry_input_components(mut self, value: u32)
        -> VkPhysicalDeviceLimitsBuilder<'a>
    {
    ...
    pub fn max_geometry_output_components(mut self, value: u32)
        -> VkPhysicalDeviceLimitsBuilder<'a>
    {
    ...
    pub fn max_fragment_input_components(mut self, value: u32)
        -> VkPhysicalDeviceLimitsBuilder<'a>
    {
    ...
    pub fn max_compute_shared_memory_size(mut self, value: u32)
        -> VkPhysicalDeviceLimitsBuilder<'a>
    {
...
impl<'a> VkImageFormatPropertiesBuilder<'a>
{
    ...
    pub fn sample_counts(mut self, value: VkSampleCountFlags)
        -> VkImageFormatPropertiesBuilder<'a>
    {
...
impl<'a> VkFormatPropertiesBuilder<'a>
{
    ...
    pub fn linear_tiling_features(
        mut self,
        value: VkFormatFeatureFlags,
    ) -> VkFormatPropertiesBuilder<'a>
    {
