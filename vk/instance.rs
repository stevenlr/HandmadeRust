...
impl Instance
{
    ...
    {
        let commands = InstanceCommands::load(|fn_name| unsafe {
            entry.s.get_instance_proc_addr(instance, fn_name.as_ptr())
        });
        Self {
            handle: instance,
            i: commands,
    ...
    pub fn get_physical_device_win_32_presentation_support_khr(
        &self,
    ...
    pub fn create_win_32_surface_khr(
        &self,
    ...
    pub fn get_physical_device_surface_present_modes_khr_count(
        &self,
        physical_device: VkPhysicalDevice,
    ...
    pub fn get_physical_device_surface_formats_khr_count(
        &self,
        physical_device: VkPhysicalDevice,
        surface: VkSurfaceKHR,
    ) -> Result<(VkResult, usize), VkResult>
    ...
    pub fn get_physical_device_sparse_image_format_properties_count(
        &self,
        physical_device: VkPhysicalDevice,
        format: VkFormat,
        kind: VkImageType,
    ...
    pub fn enumerate_device_extension_properties_count(
        &self,
        physical_device: VkPhysicalDevice,
    ...
    pub fn get_physical_device_queue_family_properties_count(
        &self,
        physical_device: VkPhysicalDevice,
    ) -> usize
    {
