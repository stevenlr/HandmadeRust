    ...
    pub fn load(load_fn: impl Fn(&[u8]) -> Option<PfnVkVoidFunction>) -> Self
    {
        StaticCommands {
            pfn_get_instance_proc_addr: unsafe {
                core::mem::transmute(load_fn(b"vkGetInstanceProcAddr\0"))
            },
        }
    }
...
impl EntryCommands
{
    ...
    {
        (self.pfn_create_instance)(p_create_info, p_allocator, p_instance)
    }
}
...
{
    pfn_get_physical_device_win_32_presentation_support_khr:
        PfnVkGetPhysicalDeviceWin32PresentationSupportKHR,
    ...
    pfn_get_physical_device_sparse_image_format_properties:
        PfnVkGetPhysicalDeviceSparseImageFormatProperties,
...
impl InstanceCommands
{
    pub fn load(load_fn: impl Fn(&[u8]) -> Option<PfnVkVoidFunction>) -> Self
    {
        InstanceCommands {
            pfn_get_physical_device_win_32_presentation_support_khr: unsafe {
                core::mem::transmute(load_fn(b"vkGetPhysicalDeviceWin32PresentationSupportKHR\0"))
            },
            pfn_create_win_32_surface_khr: unsafe {
                core::mem::transmute(load_fn(b"vkCreateWin32SurfaceKHR\0"))
            },
            pfn_get_physical_device_surface_present_modes_khr: unsafe {
                core::mem::transmute(load_fn(b"vkGetPhysicalDeviceSurfacePresentModesKHR\0"))
            },
            pfn_get_physical_device_surface_formats_khr: unsafe {
                core::mem::transmute(load_fn(b"vkGetPhysicalDeviceSurfaceFormatsKHR\0"))
            },
            pfn_get_physical_device_surface_capabilities_khr: unsafe {
                core::mem::transmute(load_fn(b"vkGetPhysicalDeviceSurfaceCapabilitiesKHR\0"))
            },
            pfn_get_physical_device_surface_support_khr: unsafe {
                core::mem::transmute(load_fn(b"vkGetPhysicalDeviceSurfaceSupportKHR\0"))
            },
            pfn_destroy_surface_khr: unsafe {
                core::mem::transmute(load_fn(b"vkDestroySurfaceKHR\0"))
            },
            pfn_submit_debug_utils_message_ext: unsafe {
                core::mem::transmute(load_fn(b"vkSubmitDebugUtilsMessageEXT\0"))
            },
            pfn_destroy_debug_utils_messenger_ext: unsafe {
                core::mem::transmute(load_fn(b"vkDestroyDebugUtilsMessengerEXT\0"))
            },
            pfn_create_debug_utils_messenger_ext: unsafe {
                core::mem::transmute(load_fn(b"vkCreateDebugUtilsMessengerEXT\0"))
            },
            pfn_cmd_insert_debug_utils_label_ext: unsafe {
                core::mem::transmute(load_fn(b"vkCmdInsertDebugUtilsLabelEXT\0"))
            },
            pfn_cmd_end_debug_utils_label_ext: unsafe {
                core::mem::transmute(load_fn(b"vkCmdEndDebugUtilsLabelEXT\0"))
            },
            pfn_cmd_begin_debug_utils_label_ext: unsafe {
                core::mem::transmute(load_fn(b"vkCmdBeginDebugUtilsLabelEXT\0"))
            },
            pfn_queue_insert_debug_utils_label_ext: unsafe {
                core::mem::transmute(load_fn(b"vkQueueInsertDebugUtilsLabelEXT\0"))
            },
            pfn_queue_end_debug_utils_label_ext: unsafe {
                core::mem::transmute(load_fn(b"vkQueueEndDebugUtilsLabelEXT\0"))
            },
            pfn_queue_begin_debug_utils_label_ext: unsafe {
                core::mem::transmute(load_fn(b"vkQueueBeginDebugUtilsLabelEXT\0"))
            },
            pfn_set_debug_utils_object_tag_ext: unsafe {
                core::mem::transmute(load_fn(b"vkSetDebugUtilsObjectTagEXT\0"))
            },
            pfn_set_debug_utils_object_name_ext: unsafe {
                core::mem::transmute(load_fn(b"vkSetDebugUtilsObjectNameEXT\0"))
            },
            pfn_get_physical_device_sparse_image_format_properties: unsafe {
                core::mem::transmute(load_fn(b"vkGetPhysicalDeviceSparseImageFormatProperties\0"))
            },
            pfn_enumerate_device_layer_properties: unsafe {
                core::mem::transmute(load_fn(b"vkEnumerateDeviceLayerProperties\0"))
            },
            pfn_enumerate_device_extension_properties: unsafe {
                core::mem::transmute(load_fn(b"vkEnumerateDeviceExtensionProperties\0"))
            },
            pfn_create_device: unsafe { core::mem::transmute(load_fn(b"vkCreateDevice\0")) },
            pfn_get_device_proc_addr: unsafe {
                core::mem::transmute(load_fn(b"vkGetDeviceProcAddr\0"))
            },
            pfn_get_physical_device_memory_properties: unsafe {
                core::mem::transmute(load_fn(b"vkGetPhysicalDeviceMemoryProperties\0"))
            },
            pfn_get_physical_device_queue_family_properties: unsafe {
                core::mem::transmute(load_fn(b"vkGetPhysicalDeviceQueueFamilyProperties\0"))
            },
            pfn_get_physical_device_properties: unsafe {
                core::mem::transmute(load_fn(b"vkGetPhysicalDeviceProperties\0"))
            },
            pfn_get_physical_device_image_format_properties: unsafe {
                core::mem::transmute(load_fn(b"vkGetPhysicalDeviceImageFormatProperties\0"))
            },
            pfn_get_physical_device_format_properties: unsafe {
                core::mem::transmute(load_fn(b"vkGetPhysicalDeviceFormatProperties\0"))
            },
            pfn_get_physical_device_features: unsafe {
                core::mem::transmute(load_fn(b"vkGetPhysicalDeviceFeatures\0"))
            },
            pfn_enumerate_physical_devices: unsafe {
                core::mem::transmute(load_fn(b"vkEnumeratePhysicalDevices\0"))
            },
    ...
    {
        (self.pfn_create_win_32_surface_khr)(instance, p_create_info, p_allocator, p_surface)
    }
    ...
    {
        (self.pfn_destroy_surface_khr)(instance, surface, p_allocator)
    }
    ...
    {
        (self.pfn_destroy_debug_utils_messenger_ext)(instance, messenger, p_allocator)
    }
    ...
    {
        (self.pfn_cmd_insert_debug_utils_label_ext)(command_buffer, p_label_info)
    }

    #[inline]
    pub unsafe fn cmd_end_debug_utils_label_ext(&self, command_buffer: VkCommandBuffer)
    {
        (self.pfn_cmd_end_debug_utils_label_ext)(command_buffer)
    }
    ...
    {
        (self.pfn_cmd_begin_debug_utils_label_ext)(command_buffer, p_label_info)
    }
    ...
    {
        (self.pfn_queue_insert_debug_utils_label_ext)(queue, p_label_info)
    }

    #[inline]
    pub unsafe fn queue_end_debug_utils_label_ext(&self, queue: VkQueue)
    {
        (self.pfn_queue_end_debug_utils_label_ext)(queue)
    }
    ...
    {
        (self.pfn_queue_begin_debug_utils_label_ext)(queue, p_label_info)
    }
    ...
    {
        (self.pfn_set_debug_utils_object_tag_ext)(device, p_tag_info)
    }
    ...
    {
        (self.pfn_set_debug_utils_object_name_ext)(device, p_name_info)
    }
    ...
    {
        (self.pfn_create_device)(physical_device, p_create_info, p_allocator, p_device)
    }
    ...
    {
        (self.pfn_get_physical_device_memory_properties)(physical_device, p_memory_properties)
    }
    ...
    {
        (self.pfn_get_physical_device_properties)(physical_device, p_properties)
    }
    ...
    {
        (self.pfn_get_physical_device_features)(physical_device, p_features)
    }
    ...
    {
        (self.pfn_enumerate_physical_devices)(instance, p_physical_device_count, p_physical_devices)
    }
    ...
    {
        (self.pfn_destroy_instance)(instance, p_allocator)
    }
}
...
impl DeviceCommands
{
    ...
    {
        (self.pfn_queue_present_khr)(queue, p_present_info)
    }
    ...
    {
        (self.pfn_destroy_swapchain_khr)(device, swapchain, p_allocator)
    }
    ...
    {
        (self.pfn_create_swapchain_khr)(device, p_create_info, p_allocator, p_swapchain)
    }
    ...
    {
        (self.pfn_cmd_execute_commands)(command_buffer, command_buffer_count, p_command_buffers)
    }

    #[inline]
    pub unsafe fn cmd_end_render_pass(&self, command_buffer: VkCommandBuffer)
    {
        (self.pfn_cmd_end_render_pass)(command_buffer)
    }
    ...
    {
        (self.pfn_cmd_next_subpass)(command_buffer, contents)
    }
    ...
    {
        (self.pfn_cmd_begin_render_pass)(command_buffer, p_render_pass_begin, contents)
    }
    ...
    {
        (self.pfn_cmd_push_constants)(command_buffer, layout, stage_flags, offset, size, p_values)
    }
    ...
    {
        (self.pfn_cmd_write_timestamp)(command_buffer, pipeline_stage, query_pool, query)
    }
    ...
    {
        (self.pfn_cmd_reset_query_pool)(command_buffer, query_pool, first_query, query_count)
    }
    ...
    {
        (self.pfn_cmd_end_query)(command_buffer, query_pool, query)
    }
    ...
    {
        (self.pfn_cmd_begin_query)(command_buffer, query_pool, query, flags)
    }
    ...
    {
        (self.pfn_cmd_reset_event)(command_buffer, event, stage_mask)
    }
    ...
    {
        (self.pfn_cmd_set_event)(command_buffer, event, stage_mask)
    }
    ...
    {
        (self.pfn_cmd_fill_buffer)(command_buffer, dst_buffer, dst_offset, size, data)
    }
    ...
    {
        (self.pfn_cmd_update_buffer)(command_buffer, dst_buffer, dst_offset, data_size, p_data)
    }
    ...
    {
        (self.pfn_cmd_dispatch_indirect)(command_buffer, buffer, offset)
    }
    ...
    {
        (self.pfn_cmd_dispatch)(command_buffer, group_count_x, group_count_y, group_count_z)
    }
    ...
    {
        (self.pfn_cmd_draw_indexed_indirect)(command_buffer, buffer, offset, draw_count, stride)
    }
    ...
    {
        (self.pfn_cmd_draw_indirect)(command_buffer, buffer, offset, draw_count, stride)
    }
    ...
    {
        (self.pfn_cmd_bind_index_buffer)(command_buffer, buffer, offset, index_type)
    }
    ...
    {
        (self.pfn_cmd_set_stencil_reference)(command_buffer, face_mask, reference)
    }
    ...
    {
        (self.pfn_cmd_set_stencil_write_mask)(command_buffer, face_mask, write_mask)
    }
    ...
    {
        (self.pfn_cmd_set_stencil_compare_mask)(command_buffer, face_mask, compare_mask)
    }
    ...
    {
        (self.pfn_cmd_set_depth_bounds)(command_buffer, min_depth_bounds, max_depth_bounds)
    }
    ...
    {
        (self.pfn_cmd_set_blend_constants)(command_buffer, blend_constants)
    }
    ...
    #[inline]
    pub unsafe fn cmd_set_line_width(&self, command_buffer: VkCommandBuffer, line_width: f32)
    {
        (self.pfn_cmd_set_line_width)(command_buffer, line_width)
    }
    ...
    {
        (self.pfn_cmd_set_scissor)(command_buffer, first_scissor, scissor_count, p_scissors)
    }
    ...
    {
        (self.pfn_cmd_set_viewport)(command_buffer, first_viewport, viewport_count, p_viewports)
    }
    ...
    {
        (self.pfn_cmd_bind_pipeline)(command_buffer, pipeline_bind_point, pipeline)
    }
    ...
    {
        (self.pfn_reset_command_buffer)(command_buffer, flags)
    }

    #[inline]
    pub unsafe fn end_command_buffer(&self, command_buffer: VkCommandBuffer) -> VkResult
    {
        (self.pfn_end_command_buffer)(command_buffer)
    }
    ...
    {
        (self.pfn_begin_command_buffer)(command_buffer, p_begin_info)
    }
    ...
    {
        (self.pfn_allocate_command_buffers)(device, p_allocate_info, p_command_buffers)
    }
    ...
    {
        (self.pfn_reset_command_pool)(device, command_pool, flags)
    }
    ...
    {
        (self.pfn_destroy_command_pool)(device, command_pool, p_allocator)
    }
    ...
    {
        (self.pfn_create_command_pool)(device, p_create_info, p_allocator, p_command_pool)
    }
    ...
    {
        (self.pfn_get_render_area_granularity)(device, render_pass, p_granularity)
    }
    ...
    {
        (self.pfn_destroy_render_pass)(device, render_pass, p_allocator)
    }
    ...
    {
        (self.pfn_create_render_pass)(device, p_create_info, p_allocator, p_render_pass)
    }
    ...
    {
        (self.pfn_destroy_framebuffer)(device, framebuffer, p_allocator)
    }
    ...
    {
        (self.pfn_create_framebuffer)(device, p_create_info, p_allocator, p_framebuffer)
    }
    ...
    {
        (self.pfn_allocate_descriptor_sets)(device, p_allocate_info, p_descriptor_sets)
    }
    ...
    {
        (self.pfn_reset_descriptor_pool)(device, descriptor_pool, flags)
    }
    ...
    {
        (self.pfn_destroy_descriptor_pool)(device, descriptor_pool, p_allocator)
    }
    ...
    {
        (self.pfn_create_descriptor_pool)(device, p_create_info, p_allocator, p_descriptor_pool)
    }
    ...
    {
        (self.pfn_destroy_descriptor_set_layout)(device, descriptor_set_layout, p_allocator)
    }
    ...
    {
        (self.pfn_create_descriptor_set_layout)(device, p_create_info, p_allocator, p_set_layout)
    }
    ...
    {
        (self.pfn_destroy_sampler)(device, sampler, p_allocator)
    }
    ...
    {
        (self.pfn_create_sampler)(device, p_create_info, p_allocator, p_sampler)
    }
    ...
    {
        (self.pfn_destroy_pipeline_layout)(device, pipeline_layout, p_allocator)
    }
    ...
    {
        (self.pfn_create_pipeline_layout)(device, p_create_info, p_allocator, p_pipeline_layout)
    }
    ...
    {
        (self.pfn_destroy_pipeline)(device, pipeline, p_allocator)
    }
    ...
    {
        (self.pfn_merge_pipeline_caches)(device, dst_cache, src_cache_count, p_src_caches)
    }
    ...
    {
        (self.pfn_get_pipeline_cache_data)(device, pipeline_cache, p_data_size, p_data)
    }
    ...
    {
        (self.pfn_destroy_pipeline_cache)(device, pipeline_cache, p_allocator)
    }
    ...
    {
        (self.pfn_create_pipeline_cache)(device, p_create_info, p_allocator, p_pipeline_cache)
    }
    ...
    {
        (self.pfn_destroy_shader_module)(device, shader_module, p_allocator)
    }
    ...
    {
        (self.pfn_create_shader_module)(device, p_create_info, p_allocator, p_shader_module)
    }
    ...
    {
        (self.pfn_destroy_image_view)(device, image_view, p_allocator)
    }
    ...
    {
        (self.pfn_create_image_view)(device, p_create_info, p_allocator, p_view)
    }
    ...
    {
        (self.pfn_get_image_subresource_layout)(device, image, p_subresource, p_layout)
    }
    ...
    {
        (self.pfn_destroy_image)(device, image, p_allocator)
    }
    ...
    {
        (self.pfn_create_image)(device, p_create_info, p_allocator, p_image)
    }
    ...
    {
        (self.pfn_destroy_buffer_view)(device, buffer_view, p_allocator)
    }
    ...
    {
        (self.pfn_create_buffer_view)(device, p_create_info, p_allocator, p_view)
    }
    ...
    {
        (self.pfn_destroy_buffer)(device, buffer, p_allocator)
    }
    ...
    {
        (self.pfn_create_buffer)(device, p_create_info, p_allocator, p_buffer)
    }
    ...
    {
        (self.pfn_destroy_query_pool)(device, query_pool, p_allocator)
    }
    ...
    {
        (self.pfn_create_query_pool)(device, p_create_info, p_allocator, p_query_pool)
    }

    #[inline]
    pub unsafe fn reset_event(&self, device: VkDevice, event: VkEvent) -> VkResult
    {
        (self.pfn_reset_event)(device, event)
    }

    #[inline]
    pub unsafe fn set_event(&self, device: VkDevice, event: VkEvent) -> VkResult
    {
        (self.pfn_set_event)(device, event)
    }

    #[inline]
    pub unsafe fn get_event_status(&self, device: VkDevice, event: VkEvent) -> VkResult
    {
        (self.pfn_get_event_status)(device, event)
    }
    ...
    {
        (self.pfn_destroy_event)(device, event, p_allocator)
    }
    ...
    {
        (self.pfn_create_event)(device, p_create_info, p_allocator, p_event)
    }
    ...
    {
        (self.pfn_destroy_semaphore)(device, semaphore, p_allocator)
    }
    ...
    {
        (self.pfn_create_semaphore)(device, p_create_info, p_allocator, p_semaphore)
    }
    ...
    {
        (self.pfn_wait_for_fences)(device, fence_count, p_fences, wait_all, timeout)
    }

    #[inline]
    pub unsafe fn get_fence_status(&self, device: VkDevice, fence: VkFence) -> VkResult
    {
        (self.pfn_get_fence_status)(device, fence)
    }
    ...
    {
        (self.pfn_reset_fences)(device, fence_count, p_fences)
    }
    ...
    {
        (self.pfn_destroy_fence)(device, fence, p_allocator)
    }
    ...
    {
        (self.pfn_create_fence)(device, p_create_info, p_allocator, p_fence)
    }
    ...
    {
        (self.pfn_queue_bind_sparse)(queue, bind_info_count, p_bind_info, fence)
    }
    ...
    {
        (self.pfn_get_image_memory_requirements)(device, image, p_memory_requirements)
    }
    ...
    {
        (self.pfn_get_buffer_memory_requirements)(device, buffer, p_memory_requirements)
    }
    ...
    {
        (self.pfn_bind_image_memory)(device, image, memory, memory_offset)
    }
    ...
    {
        (self.pfn_bind_buffer_memory)(device, buffer, memory, memory_offset)
    }
    ...
    {
        (self.pfn_get_device_memory_commitment)(device, memory, p_committed_memory_in_bytes)
    }
    ...
    {
        (self.pfn_invalidate_mapped_memory_ranges)(device, memory_range_count, p_memory_ranges)
    }
    ...
    {
        (self.pfn_flush_mapped_memory_ranges)(device, memory_range_count, p_memory_ranges)
    }

    #[inline]
    pub unsafe fn unmap_memory(&self, device: VkDevice, memory: VkDeviceMemory)
    {
        (self.pfn_unmap_memory)(device, memory)
    }
    ...
    {
        (self.pfn_map_memory)(device, memory, offset, size, flags, pp_data)
    }
    ...
    {
        (self.pfn_free_memory)(device, memory, p_allocator)
    }
    ...
    {
        (self.pfn_allocate_memory)(device, p_allocate_info, p_allocator, p_memory)
    }

    #[inline]
    pub unsafe fn device_wait_idle(&self, device: VkDevice) -> VkResult
    {
        (self.pfn_device_wait_idle)(device)
    }

    #[inline]
    pub unsafe fn queue_wait_idle(&self, queue: VkQueue) -> VkResult
    {
        (self.pfn_queue_wait_idle)(queue)
    }
    ...
    {
        (self.pfn_queue_submit)(queue, submit_count, p_submits, fence)
    }
    ...
    {
        (self.pfn_get_device_queue)(device, queue_family_index, queue_index, p_queue)
    }

    #[inline]
    pub unsafe fn destroy_device(&self, device: VkDevice, p_allocator: *const VkAllocationCallbacks)
    {
        (self.pfn_destroy_device)(device, p_allocator)
    }
}
